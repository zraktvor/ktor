...
suspend fun ByteWriteChannel.writeDnsMessage(message: Message, encoder: CharsetEncoder, tcp: Boolean = true) {
    if (tcp) {
...
private suspend fun ByteWriteChannel.writeResource(resource: Resource<*>,
                                                   @Suppress("UNUSED_PARAMETER") encoder: CharsetEncoder) {
