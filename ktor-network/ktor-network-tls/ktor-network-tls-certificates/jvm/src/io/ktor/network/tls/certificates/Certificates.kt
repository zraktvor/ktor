...
private fun certificate(
    ...
    val certificateBytes = buildPacket {
        writeCertificate(
            ...
            keyPair = keyPair, signerKeyPair = signerKeyPair,
            algorithm = algorithm,
            from = from, to = to,
 ...
 * Tag: Byte
 * Length: Byte
 * Value: ByteArray or null
 *
 * @see: https://docs.microsoft.com/en-us/windows/win32/seccertenroll/about-der-encoding-of-asn-1-types
 */
